...
CAT = f".\\AnimalData\\Cat"
DOG = f".\\AnimalData\\Dog"
DEER = f".\\AnimalData\\Deer"
CAPYBARA = f".\\AnimalData\\Capybara"
KANGAROO = f".\\AnimalData\\Kangaroo"

test_path = "test.jpg"
preprocessed_output_dir = "preprocessed_img"

LABELS = [CAT, DOG, DEER, CAPYBARA, KANGAROO]
