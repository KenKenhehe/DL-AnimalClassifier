...
import time
wd = webdriver.Chrome()
animal_search_keyword = "Kangaroo"
output_folder = f"AnimalData/{animal_search_keyword}/"
if(not os.path.exists(output_folder)):
    os.mkdir(output_folder)
search_url = f"https://www.google.com/search?q={animal_search_keyword}&sca_esv=593217386&rlz=1C1ONGR_en-GBAU991AU991&tbm=isch&sxsrf=AM9HkKlohH319t3cpas3Ap-RLTbk8KecTw:1703314619525&source=lnms&sa=X&ved=2ahUKEwijldm2_aSDAxVhamwGHfmqAwMQ_AUoAXoECAQQAw&biw=1920&bih=963&dpr=1"
